...
class Quiz {
  ...
  constructor() {
    ...
    this.questions.push(
      ...
      new Question("Which planet is closest to the sun?", ["Venus", "Mars", "Mercury"], 2),
      new Question("What is the largest mammal?", ["Elephant", "Giraffe", "Blue Whale"], 2),
      new CodeQuestion("What is the result of 3 + 7?", ["10", "12", "8"], 0),
      new Question("Who painted the Mona Lisa?", ["Leonardo da Vinci", "Pablo Picasso", "Vincent van Gogh"], 0),
      new CodeQuestion("What is the output of 'console.log('Hello, World!');' in JavaScript?", ["Hello, World!", "World, Hello!", "Error"], 0),
    );
